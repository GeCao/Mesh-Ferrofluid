...
from src.mesh_BEM import AbstractBEMSolver, SingleLayer2d, DoubleLayer2d, RhsLayer2d
...
class MeshBEMSolver2d(AbstractBEMSolver):
    rank = 2
    ...
    def __init__(
        ...
        super(MeshBEMSolver2d, self).__init__(
            gaussQR=gaussQR,
        ...
        self.single_layer = SingleLayer2d(
        ...
        self.double_layer = DoubleLayer2d(
            gaussQR=self.gaussQR,
            order_type=self.order_type,
            BEM_type=self.BEM_type,
            wavenumber=self.wavenumber,
